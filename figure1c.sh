...
for file in *;do echo "bedtools intersect -a $file -b ../../Raw_Methylation_bedgraphs_4_Cells/${file/_BS_*/_BS_1.profile.cg_strand_combined.bedgraph} -wa -wb | groupBy -g 1,2,3,4,5,6,7 -c 11 -o sum | awk '{print \$0\"\t\"\$8/\$7}' > ../CpG_counts_sum_average/${file/-K36me2_CpG_counts.dat/-Parental-K36me2-domain_CpG_counts_sum_average.dat}" | bash;done
