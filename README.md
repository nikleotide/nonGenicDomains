...
<br>
The bedgraph files for this igv session can be downloaded from <a href="https://github.com/nikleotide/nonGenicDomains/blob/master/Merged_then_Intersected.zip" target="_"blank>here</a>
